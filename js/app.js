(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".team-block__slider")) new core(".team-block__slider", {
            ...
            loopedSlides: 4,
            navigation: {
                prevEl: ".team-block__prev",
                nextEl: ".team-block__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".other-courses__slider")) new core(".other-courses__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
        ...
        if (document.querySelector(".other-event__slider")) new core(".other-event__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".other-event__prev",
                nextEl: ".other-event__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".other-posts__slider")) new core(".other-posts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".other-posts__prev",
                nextEl: ".other-posts__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const deadline = new Date("2022", "11", "11", "11", "12");
        let timerId = null;
        ...
        const $days = document.querySelector(".discount-timer__days");
        const $hours = document.querySelector(".discount-timer__hours");
        const $minutes = document.querySelector(".discount-timer__minutes");
        const $seconds = document.querySelector(".discount-timer__seconds");
        countdownTimer();
